...
@router.get("/students/{student_id}/competencies", response_model=StudentCompetenciesResponse)
...
@router.get("/students/{student_id}/mastery/{topic}", response_model=MasterySummaryResponse)
...
@router.get("/students/{student_id}/recommended-concepts/{topic}", response_model=RecommendedConceptsResponse)
